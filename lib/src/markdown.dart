...
/// A [link reference
/// definition](http://spec.commonmark.org/0.30/#link-reference-definitions).
class LinkReference {
  /// The [link label](http://spec.commonmark.org/0.30/#link-label).
  ///
  ...
  /// The [link destination](http://spec.commonmark.org/0.30/#link-destination).
  final String destination;

  /// The [link title](http://spec.commonmark.org/0.30/#link-title).
  final String? title;
